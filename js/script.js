...
AddressBook.prototype.UpdateContact = function (contact) {
  ...
  this.contacts[id].address = contact.address
  this.contacts[id].workAddress = contact.workAddress
  this.contacts[id].otherAddress = contact.otherAddress
  this.contacts[id].workEmail = contact.workEmail
  return true;
};
...
$(document).ready(function () {
  ...
  $('form#new-contact').submit(function (event) {
    ...
    let newContact = new Contact(inputtedFirstName, inputtedLastName, inputtedPhoneNumber, inputtedEmail, inputtedAddress, inputtedOtherAddress, inputtedWorkAddress, inputtedWorkEmail);
